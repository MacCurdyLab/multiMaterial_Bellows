...
bellows_fgrade = pv.FGrade(
    [
          "0.7444444444 -0.0285253650 * cos(1*pi ((x^2 + y^2)^0.5)/15) +0.2905126355 * cos(2*pi ((x^2 + y^2)^0.5)/15) +0.0531316109 * cos(3*pi ((x^2 + y^2)^0.5)/15) -0.1452761855 * cos(4*pi ((x^2 + y^2)^0.5)/15) -0.0311770676 * cos(5*pi ((x^2 + y^2)^0.5)/15) +0.0279360311 * cos(6*pi ((x^2 + y^2)^0.5)/15) -0.0023004811 * cos(7*pi ((x^2 + y^2)^0.5)/15) +0.0197603967 * cos(8*pi ((x^2 + y^2)^0.5)/15) +0.0173937751 * cos(9*pi ((x^2 + y^2)^0.5)/15) -0.0144250606 * cos(10*pi ((x^2 + y^2)^0.5)/15) -0.0069754540 * cos(11*pi ((x^2 + y^2)^0.5)/15) -0.0014434597 * cos(12*pi ((x^2 + y^2)^0.5)/15) -0.0078826661 * cos(13*pi ((x^2 + y^2)^0.5)/15) +0.0051679067 * cos(14*pi ((x^2 + y^2)^0.5)/15) +0.0081135113 * cos(15*pi ((x^2 + y^2)^0.5)/15) -0.0010464851 * cos(16*pi ((x^2 + y^2)^0.5)/15) +0.0017060875 * cos(17*pi ((x^2 + y^2)^0.5)/15) -0.0009076264 * cos(18*pi ((x^2 + y^2)^0.5)/15) -0.0061822839 * cos(19*pi ((x^2 + y^2)^0.5)/15) -0.0000108156 * cos(20*pi ((x^2 + y^2)^0.5)/15) +0.0015346841 * cos(21*pi ((x^2 + y^2)^0.5)/15) -0.0001674859 * cos(22*pi ((x^2 + y^2)^0.5)/15) +0.0034366160 * cos(23*pi ((x^2 + y^2)^0.5)/15) +0.0011890350 * cos(24*pi ((x^2 + y^2)^0.5)/15) -0.0024650424 * cos(25*pi ((x^2 + y^2)^0.5)/15) -0.0003371264 * cos(26*pi ((x^2 + y^2)^0.5)/15) -0.0011612058 * cos(27*pi ((x^2 + y^2)^0.5)/15) -0.0014847404 * cos(28*pi ((x^2 + y^2)^0.5)/15) +0.0019853218 * cos(29*pi ((x^2 + y^2)^0.5)/15) +0.0011833340 * cos(30*pi ((x^2 + y^2)^0.5)/15) -0.0000949911 * cos(31*pi ((x^2 + y^2)^0.5)/15) +0.0009489927 * cos(32*pi ((x^2 + y^2)^0.5)/15) -0.0010238990 * cos(33*pi ((x^2 + y^2)^0.5)/15) -0.0016361398 * cos(34*pi ((x^2 + y^2)^0.5)/15) +0.0003792167 * cos(35*pi ((x^2 + y^2)^0.5)/15) -0.0000695065 * cos(36*pi ((x^2 + y^2)^0.5)/15) +0.0002643202 * cos(37*pi ((x^2 + y^2)^0.5)/15) +0.0014867408 * cos(38*pi ((x^2 + y^2)^0.5)/15) -0.0000960150 * cos(39*pi ((x^2 + y^2)^0.5)/15) -0.0006476525 * cos(40*pi ((x^2 + y^2)^0.5)/15) +0.0000012965 * cos(41*pi ((x^2 + y^2)^0.5)/15) -0.0009198635 * cos(42*pi ((x^2 + y^2)^0.5)/15) -0.0002781258 * cos(43*pi ((x^2 + y^2)^0.5)/15) +0.0009266896 * cos(44*pi ((x^2 + y^2)^0.5)/15) +0.0001571248 * cos(45*pi ((x^2 + y^2)^0.5)/15) +0.0002836372 * cos(46*pi ((x^2 + y^2)^0.5)/15) +0.0004214925 * cos(47*pi ((x^2 + y^2)^0.5)/15) -0.0007831665 * cos(48*pi ((x^2 + y^2)^0.5)/15) -0.0004702751 * cos(49*pi ((x^2 + y^2)^0.5)/15) +0.0001337230 * cos(50*pi ((x^2 + y^2)^0.5)/15) -0.0002611723 * cos(51*pi ((x^2 + y^2)^0.5)/15) +0.0004314730 * cos(52*pi ((x^2 + y^2)^0.5)/15) +0.0006688191 * cos(53*pi ((x^2 + y^2)^0.5)/15) -0.0002317280 * cos(54*pi ((x^2 + y^2)^0.5)/15) -0.0000722864 * cos(55*pi ((x^2 + y^2)^0.5)/15) -0.0001228590 * cos(56*pi ((x^2 + y^2)^0.5)/15) -0.0006236861 * cos(57*pi ((x^2 + y^2)^0.5)/15) +0.0000982079 * cos(58*pi ((x^2 + y^2)^0.5)/15) +0.0003742851 * cos(59*pi ((x^2 + y^2)^0.5)/15) +0.0000082089 * cos(60*pi ((x^2 + y^2)^0.5)/15)",
          "0.2555555556 +0.0285253650 * cos(1*pi ((x^2 + y^2)^0.5)/15) -0.2905126355 * cos(2*pi ((x^2 + y^2)^0.5)/15) -0.0531316109 * cos(3*pi ((x^2 + y^2)^0.5)/15) +0.1452761855 * cos(4*pi ((x^2 + y^2)^0.5)/15) +0.0311770676 * cos(5*pi ((x^2 + y^2)^0.5)/15) -0.0279360311 * cos(6*pi ((x^2 + y^2)^0.5)/15) +0.0023004811 * cos(7*pi ((x^2 + y^2)^0.5)/15) -0.0197603967 * cos(8*pi ((x^2 + y^2)^0.5)/15) -0.0173937751 * cos(9*pi ((x^2 + y^2)^0.5)/15) +0.0144250606 * cos(10*pi ((x^2 + y^2)^0.5)/15) +0.0069754540 * cos(11*pi ((x^2 + y^2)^0.5)/15) +0.0014434597 * cos(12*pi ((x^2 + y^2)^0.5)/15) +0.0078826661 * cos(13*pi ((x^2 + y^2)^0.5)/15) -0.0051679067 * cos(14*pi ((x^2 + y^2)^0.5)/15) -0.0081135113 * cos(15*pi ((x^2 + y^2)^0.5)/15) +0.0010464851 * cos(16*pi ((x^2 + y^2)^0.5)/15) -0.0017060875 * cos(17*pi ((x^2 + y^2)^0.5)/15) +0.0009076264 * cos(18*pi ((x^2 + y^2)^0.5)/15) +0.0061822839 * cos(19*pi ((x^2 + y^2)^0.5)/15) +0.0000108156 * cos(20*pi ((x^2 + y^2)^0.5)/15) -0.0015346841 * cos(21*pi ((x^2 + y^2)^0.5)/15) +0.0001674859 * cos(22*pi ((x^2 + y^2)^0.5)/15) -0.0034366160 * cos(23*pi ((x^2 + y^2)^0.5)/15) -0.0011890350 * cos(24*pi ((x^2 + y^2)^0.5)/15) +0.0024650424 * cos(25*pi ((x^2 + y^2)^0.5)/15) +0.0003371264 * cos(26*pi ((x^2 + y^2)^0.5)/15) +0.0011612058 * cos(27*pi ((x^2 + y^2)^0.5)/15) +0.0014847404 * cos(28*pi ((x^2 + y^2)^0.5)/15) -0.0019853218 * cos(29*pi ((x^2 + y^2)^0.5)/15) -0.0011833340 * cos(30*pi ((x^2 + y^2)^0.5)/15) +0.0000949911 * cos(31*pi ((x^2 + y^2)^0.5)/15) -0.0009489927 * cos(32*pi ((x^2 + y^2)^0.5)/15) +0.0010238990 * cos(33*pi ((x^2 + y^2)^0.5)/15) +0.0016361398 * cos(34*pi ((x^2 + y^2)^0.5)/15) -0.0003792167 * cos(35*pi ((x^2 + y^2)^0.5)/15) +0.0000695065 * cos(36*pi ((x^2 + y^2)^0.5)/15) -0.0002643202 * cos(37*pi ((x^2 + y^2)^0.5)/15) -0.0014867408 * cos(38*pi ((x^2 + y^2)^0.5)/15) +0.0000960150 * cos(39*pi ((x^2 + y^2)^0.5)/15) +0.0006476525 * cos(40*pi ((x^2 + y^2)^0.5)/15) -0.0000012965 * cos(41*pi ((x^2 + y^2)^0.5)/15) +0.0009198635 * cos(42*pi ((x^2 + y^2)^0.5)/15) +0.0002781258 * cos(43*pi ((x^2 + y^2)^0.5)/15) -0.0009266896 * cos(44*pi ((x^2 + y^2)^0.5)/15) -0.0001571248 * cos(45*pi ((x^2 + y^2)^0.5)/15) -0.0002836372 * cos(46*pi ((x^2 + y^2)^0.5)/15) -0.0004214925 * cos(47*pi ((x^2 + y^2)^0.5)/15) +0.0007831665 * cos(48*pi ((x^2 + y^2)^0.5)/15) +0.0004702751 * cos(49*pi ((x^2 + y^2)^0.5)/15) -0.0001337230 * cos(50*pi ((x^2 + y^2)^0.5)/15) +0.0002611723 * cos(51*pi ((x^2 + y^2)^0.5)/15) -0.0004314730 * cos(52*pi ((x^2 + y^2)^0.5)/15) -0.0006688191 * cos(53*pi ((x^2 + y^2)^0.5)/15) +0.0002317280 * cos(54*pi ((x^2 + y^2)^0.5)/15) +0.0000722864 * cos(55*pi ((x^2 + y^2)^0.5)/15) +0.0001228590 * cos(56*pi ((x^2 + y^2)^0.5)/15) +0.0006236861 * cos(57*pi ((x^2 + y^2)^0.5)/15) -0.0000982079 * cos(58*pi ((x^2 + y^2)^0.5)/15) -0.0003742851 * cos(59*pi ((x^2 + y^2)^0.5)/15) -0.0000082089 * cos(60*pi ((x^2 + y^2)^0.5)/15)"
    ],
    [red, blue],
    True
)
