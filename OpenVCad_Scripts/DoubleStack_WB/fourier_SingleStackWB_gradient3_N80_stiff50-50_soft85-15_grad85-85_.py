...
# Importing mesh
bellows1 = pv.Mesh(
    "MAC_LAB/STL Files/6StackWithBaffles/6StackWB - BellowsGradientAssemblyCentered-1.STL", red)
...
# Importing Caps
cap1_mesh = pv.Mesh(
    "MAC_LAB/STL Files/6StackWithBaffles/6StackWB - CloseCap-1.STL", red)
cap2_mesh = pv.Mesh(
    "MAC_LAB/STL Files/6StackWithBaffles/6StackWB - CloseCap-2.STL", red)
...
liquid_mesh = pv.Mesh(
    "MAC_LAB/STL Files/6StackWithBaffles/6StackWB - LiquidBellowsWBAssembly-1 LiquidAssemblyWB-1.STL", liquid_mat)
# Importing support structures
support1_mesh = pv.Mesh(
    "MAC_LAB/STL Files/6StackWithBaffles/6StackWB - SupportBellowsAssembly-1.STL", green)
# Importing baffles
baffles_mesh = pv.Mesh(
    "MAC_LAB/STL Files/6StackWithBaffles/6StackWB - LiquidBellowsWBAssembly-1 Part1^LiquidBellowsWBAssembly-1.STL", green)
...
union1.add_child(baffles_mesh)

tempRect = pv.RectPrism(pv.Vec3(25/2+.125,25/2+.125,22), pv.Vec3(25,25,3), materials.id("gray"))



# setting grading as root
#root = pv.Difference(union1,tempRect)
root = union1