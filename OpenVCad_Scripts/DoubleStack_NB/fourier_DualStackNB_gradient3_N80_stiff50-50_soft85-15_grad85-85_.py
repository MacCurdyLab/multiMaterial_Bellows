...
# Design Type: Dual assembly without baffles
...
# Importing mesh
bellows1 = pv.Mesh(
    "MAC_LAB/STL Files/DualNoBaffles/DualAssemblyNoBaffles - BellowsGradientAssemblyCentered-1.STL", red)
...
bellows2 = pv.Mesh(
    "MAC_LAB/STL Files/DualNoBaffles/DualAssemblyNoBaffles - BellowsGradientAssemblyCentered-2.STL", red)
...
housing_mesh = pv.Mesh(
    "MAC_LAB/STL Files/DualNoBaffles/DualAssemblyNoBaffles - HousingAssemblyDual-1.STL", blue)
...
liquid_mesh = pv.Mesh(
    "MAC_LAB/STL Files/DualNoBaffles/DualAssemblyNoBaffles - LiquidAssemblyDual-1.STL", liquid_mat)
# Importing support structures
support1_mesh = pv.Mesh(
    "MAC_LAB/STL Files/DualNoBaffles/DualAssemblyNoBaffles - SupportBellowsAssembly-1.STL", green)
support2_mesh = pv.Mesh(
    "MAC_LAB/STL Files/DualNoBaffles/DualAssemblyNoBaffles - SupportBellowsAssembly-2.STL", green)


union1 = pv.Union()
union1.add_child(translate1)
union1.add_child(translate2)
union1.add_child(liquid_mesh)
union1.add_child(housing_fgrade)
union1.add_child(support1_mesh)
union1.add_child(support2_mesh)
