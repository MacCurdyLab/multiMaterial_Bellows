#NOTES:
    #Found how to create a 2D sketch without using a work plane and revolve that sketch to create bellows
    #Strugled with 2D fillets, seems like you need to assemble a sketch before you can fillet
    #Next Steps: try using a workplane instead and arcs instead of fillets for rounded corners
...
vero_thick = 0.2 #[mm] thickness of vero keepout layer
